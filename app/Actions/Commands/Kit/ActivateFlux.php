...
final class ActivateFlux
{
    ...
    protected function handleFileInstallation(Command $command): void
    {
    ...
    protected function handleLicenseInstallation(Command $command): void
    {
        $command->info('Activating Flux...');
        $command->line('');
    ...
    protected function addFluxProRepositoryToComposerJson(Command $command): void
    {
